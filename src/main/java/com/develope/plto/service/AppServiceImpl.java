...
public class AppServiceImpl implements AppService {
	...
	public String executeApp(long board_id,LifeCycleThread lct, String email) {
		...
		long layout_id = boardDaoImpl.selectLayoutId(board_id);//게시글에 해당하는 레이아웃을 가져옴
		...
		res_script = res_script.concat("<INPUT id=\"layout_id\" type=hidden value=\""+ layout_id +"\">");
		res_script = res_script.concat("<INPUT id=\"thread_id\" type=hidden value=\""+ at.getId() +"\">");
